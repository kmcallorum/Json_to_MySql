...
describe('DragDropMapper', () => {
  ...
  it('should open load mapping modal when Load button clicked', async () => {
    (api.listMappingConfigs as any).mockResolvedValue({
      success: true,
      configs: []
    });
  ...
  it('should show loading state in modal', async () => {
    (api.listMappingConfigs as any).mockImplementation(() => new Promise(resolve => setTimeout(resolve, 100)));
