...
describe('RelationshipEditor', () => {
    ...
    it('should render relationship editor with title', () => {
        render(_jsx(RelationshipEditor, { tables: mockTables, relationships: [], onRelationshipsChange: mockOnRelationshipsChange }));
    ...
    it('should auto-detect relationships based on _id pattern', () => {
        ...
        render(_jsx(RelationshipEditor, { tables: tablesForAutoDetect, relationships: [], onRelationshipsChange: mockOnRelationshipsChange }));
    ...
    it('should not detect relationships when no _id columns exist', () => {
        ...
        render(_jsx(RelationshipEditor, { tables: tablesWithoutFKs, relationships: [], onRelationshipsChange: mockOnRelationshipsChange }));
        const autoDetectButton = screen.getByText(/Auto-Detect Relationships/);
        fireEvent.click(autoDetectButton);
    ...
    it('should display existing relationships', () => {
        ...
        render(_jsx(RelationshipEditor, { tables: mockTables, relationships: existingRelationships, onRelationshipsChange: mockOnRelationshipsChange }));
    ...
    it('should populate form when Edit is clicked', () => {
        ...
        const parentTableSelect = selects[0];
        const childTableSelect = selects[2];
    ...
    it('should show parent columns when parent table is selected', () => {
        ...
        const parentTableSelect = selects[0];
        fireEvent.change(parentTableSelect, { target: { value: 'users' } });
        const parentKeySelect = selects[1];
    ...
    it('should show child columns when child table is selected', () => {
        ...
        const foreignKeySelect = selects[3];
    ...
    it('should disable submit button when not all fields are filled', () => {
        ...
        const submitButton = buttons.find(btn => btn.textContent?.includes('Add Relationship') && !btn.textContent?.includes('+'));
    ...
    it('should reset form when Cancel is clicked', () => {
        ...
        const parentTableSelect2 = selects2[0];
