...
describe('API Service', () => {
    ...
    describe('testConnection', () => {
        it('should test connection with credentials', async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/analysis/test-connection', {
                method: 'POST',
    ...
    describe('discoverFields', () => {
        it('should discover fields with custom sample size', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/analysis/discover-fields', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    describe('analyze', () => {
        it('should analyze with request data', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/analysis/analyze', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    describe('getTableList', () => {
        it('should get list of tables', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/tables/list', {
                method: 'GET',
                headers: { 'Content-Type': 'application/json' }
            });
        });
    ...
    describe('getTableStructures', () => {
        it('should get table structures for multiple tables', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/tables/structures', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    describe('saveMappingConfig', () => {
        it('should save mapping configuration', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/mappings/save', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    describe('loadMappingConfig', () => {
        it('should load mapping configuration', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/mappings/load/test_mapping', {
                method: 'GET',
                headers: { 'Content-Type': 'application/json' }
            });
        });
    ...
    describe('listMappingConfigs', () => {
        it('should list all mapping configurations', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/mappings/list', {
                method: 'GET',
                headers: { 'Content-Type': 'application/json' }
            });
        });
    ...
    describe('findMappingsByTables', () => {
        it('should find mappings by table names', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/mappings/find-by-tables', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    describe('deleteMappingConfig', () => {
        it('should delete mapping configuration', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/mappings/test_mapping', {
                method: 'DELETE',
                headers: { 'Content-Type': 'application/json' }
            });
        });
    ...
    describe('saveFilterPreset', () => {
        it('should save filter preset', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/filters/save', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    describe('loadFilterPreset', () => {
        it('should load filter preset', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/filters/load/active_users', {
                method: 'GET',
                headers: { 'Content-Type': 'application/json' }
            });
        });
    ...
    describe('listFilterPresets', () => {
        it('should list all filter presets without base table name', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/filters/list', {
                method: 'GET',
                headers: { 'Content-Type': 'application/json' }
            });
        });
    ...
    describe('deleteFilterPreset', () => {
        it('should delete filter preset', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/filters/active_users', {
                method: 'DELETE',
                headers: { 'Content-Type': 'application/json' }
            });
        });
    ...
    describe('executeFlattening', () => {
        it('should execute flattening operation', async () => {
            ...
            expect(result).toEqual(mockResponse);
            expect(global.fetch).toHaveBeenCalledWith('http://localhost:3001/api/mappings/execute', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
