...
describe('SaveLoadConfig Component', () => {
    ...
    it('should render save and load buttons', () => {
        render(_jsx(SaveLoadConfig, { currentConfig: mockConfig, onLoad: mockOnLoad }));
    ...
    it('should save configuration successfully', async () => {
        api.saveMappingConfig.mockResolvedValue({
            success: true,
            config: mockConfig
        });
        render(_jsx(SaveLoadConfig, { currentConfig: mockConfig, onLoad: mockOnLoad }));
        ...
        await waitFor(() => {
            expect(api.saveMappingConfig).toHaveBeenCalledWith(expect.objectContaining({
                name: 'test_config',
                ...mockConfig
            }));
        });
    ...
    it('should delete a configuration', async () => {
        ...
        api.deleteMappingConfig.mockResolvedValue({
            success: true
        });
        render(_jsx(SaveLoadConfig, { currentConfig: mockConfig, onLoad: mockOnLoad }));
        fireEvent.click(screen.getByText(/Load Configuration/i));
